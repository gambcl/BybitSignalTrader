...
public class PositionsService : IPositionsService
{
    ...
    public static string? DeterminePnlEmoji(PositionStatus status, decimal pnlPercent)
    {
    ...
    public static string FormatDuration(long startUtcMillis, long endUtcMillis)
    {
